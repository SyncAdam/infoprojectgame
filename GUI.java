...
//		numberRadioButton1.addActionListener(e -> PlayerNumber = 1);
	...
	public void refreshScreen(int[][][] G){ //on parcourt tout le tableau de jeux, a chaque fois qu'on avance d'une case on actualise la position actuelle dans la variable CurPos puis on vérifie si un pion d'une certaine taille et d'un certain joueur est présent : si c'est le cas on affiche la bonne image
